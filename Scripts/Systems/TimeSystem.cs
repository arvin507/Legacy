...
public sealed class TimeSystem
{
    ...
    public int DaysPerMonth => _config.DaysPerMonth;
    ...
    public void CompleteCurrentDay(CalendarState calendar, CharacterState character)
    {
        CompleteCurrentMonth(calendar, character);
    }

    public void CompleteCurrentMonth(CalendarState calendar, CharacterState character)
    {
        calendar.TotalMonthsSurvived++;
        calendar.TotalDaysSurvived = calendar.TotalMonthsSurvived;
        calendar.Day = 1;
        calendar.Month++;
